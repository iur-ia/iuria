          ...
          <CardContent>
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-emerald-500/10 border border-green-200">
                  <p className="text-xs text-muted-foreground">Receita Mensal</p>
                  <p className="text-lg font-bold text-green-700">R$ 285.000</p>
                </div>
                <div className="p-3 rounded-lg bg-rose-500/10 border border-red-200">
        ...
        <Card className="border-0 shadow-sm bg-card">
          ...
          <CardContent>
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-b"><td className="p-2 font-medium">Dr. Thiago Morani</td><td className="p-2 text-center">198h</td><td className="p-2 text-center">24</td><td className="p-2 text-center"><Badge className="bg-emerald-500/15 text-emerald-400 dark:bg-emerald-500/15 dark:text-emerald-300">92%</Badge></td></tr>
                <tr className="border-b"><td className="p-2 font-medium">Dra. Jennifer Santos</td><td className="p-2 text-center">144h</td><td className="p-2 text-center">18</td><td className="p-2 text-center"><Badge className="bg-emerald-500/15 text-emerald-400 dark:bg-emerald-500/15 dark:text-emerald-300">88%</Badge></td></tr>
              </tbody>
            </table>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-sm bg-card">
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              {[
                { label: "Cumpridos no prazo", value: "94%", color: "bg-emerald-500/10 text-green-700 border-green-200" },
                { label: "Em dia", value: "45", color: "bg-blue-500/10 text-blue-700 border-blue-200" },
                { label: "Próximos 7 dias", value: "12", color: "bg-amber-500/10 text-yellow-700 border-yellow-200" },
                { label: "Críticos (<48h)", value: "3", color: "bg-rose-500/10 text-red-700 border-red-200" },
              ].map((p, i) => (
