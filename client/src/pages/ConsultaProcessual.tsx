...
export default function ConsultaProcessual() {
  ...
  // Scraping fallback is handled automatically by the backend (/api/consulta-processual
  // calls pesquisarProcesso() when DataJud returns 0 results). No manual trigger needed.
