...
target = """    # DataJud deprecado por falta de dados úteis (LGPD/Restrições). Agora sempre chamaremos os métodos locais.
    return tribunal_sigla, "cnj\""""

replacement = """    # DataJud deprecado por falta de dados úteis (LGPD/Restrições). Agora sempre chamaremos os métodos locais.
    return tribunal_sigla, "cnj"

def get_router_logic(sigla: str) -> dict:
    sigla = sigla.upper()
